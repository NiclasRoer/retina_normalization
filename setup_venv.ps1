...
if ($env:VIRTUAL_ENV) {
    ...
    uv pip install --reinstall 'numpy<2.3' 'torch==2.9.1+cu128' 'torchvision==0.24.1+cu128' --index-url $PytorchIndex --extra-index-url https://pypi.org/simple --index-strategy unsafe-best-match
} else {
